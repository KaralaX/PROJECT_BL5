        ...
        <div class="wrapper">
            ...
            <div class="form-inner">
                <form acion="login" class="login" method="post">
                    <div class="field">
                        <input type="text" placeholder="Username" name="username"required="true" value="${cookie.user.value}${username}">
                    </div>
                    <div class="field">
                        <input type="password" placeholder="Password" name="password" required="true" value="${cookie.pass.value}">
                    </div>
                    <div class="check">
                        <input type="checkbox" ${(cookie.rem!=null)?"checked":""} name="rememberMe" value="rememberMe"> <label>Remember Me</label>
                    </div>
